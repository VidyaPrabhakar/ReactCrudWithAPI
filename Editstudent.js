...
class Edit extends React.Component {  
    ...
    componentDidMount() {  
      axios.get('http://localhost:63219/StudentdetailById?id='+ this.props.match.params.id)  
          .then(response => {  
              this.setState({   
    ...
    onSubmit(e) {  
        ...
        axios.post('http://localhost:63219/AddotrUpdatestudent/', obj)  
            .then(res => 
                {
                ...
                <Form className="form" onSubmit={this.onSubmit}>  
                    <Col>  
                        ...
                        <FormGroup row>  
                            ...
                            <Col sm={10}>  
                                <Input type="text" name="RollNo" value={this.state.RollNo} onChange={this.onChangeRollNo}  />  
                            </Col>  
                        </FormGroup>  
                         <FormGroup row>  
                            <Label for="Class" sm={2}>Class</Label>  
                            <Col sm={10}>  
                                <Input type="text" name="Class" value={this.state.Class} onChange={this.onChangeClass}  />  
                            </Col>  
                        </FormGroup>  
                         <FormGroup row>  
